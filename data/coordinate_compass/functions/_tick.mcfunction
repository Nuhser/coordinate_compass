...
execute as @a[nbt={SelectedItem:{id:"minecraft:compass"}}] at @s run function coordinate_compass:_player_coords
...
execute as @a[nbt={Dimension:-1,Inventory:[{Slot:-106b,id:"minecraft:compass",Count:1b}]}] at @s run function coordinate_compass:_portal_coords