...
title @s[nbt={Dimension:0},scores={cc_rotation=0..225}] actionbar [{"text": "X: "}, {"score": {"name": "@s", "objective": "cc_posX"}, "color": "yellow"}, {"text": " Y: "}, {"score": {"name": "@s", "objective": "cc_posY"}, "color": "yellow"}, {"text": " Z: "}, {"score": {"name": "@s", "objective": "cc_posZ"}, "color": "yellow"}, {"text": " | S"}]
